<template>
  <header>
    ...
    <div class="search-bar-container">
      <div class="search-home-wrapper">
        ...
        <div class="search-bar">
          ...
          <input type="text" name="" placeholder="What do you want to play?" />
          <svg
            data-encore-id="icon"
            role="img"
            aria-hidden="true"
    ...
    <div class="buttons-group">
      ...
      <router-link class="primary-button">Login</router-link>
    </div>
  </header>
</template>
...
header {
  ...
  .home-link {
    padding: 12px;
    background: vars.color(dark-grey);
    border-radius: 50%;
    height: 48px;
  }
  ...
  .search-bar {
    ...
    &:after {
      ...
      height: 24px;
      width: 1px;
      background: vars.color(light-grey);
    }
  }
